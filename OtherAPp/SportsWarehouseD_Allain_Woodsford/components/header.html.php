    ...
    <header class="site-header">
        ...
        <section class="site-header__branding">
            ...
            <div>
                <!--Search Form-->
                <form id="searchForm" role="search" action="search.php" method="get" aria-label="search form" aria-description="This form has a search text input and button that allows you to look up Products by their: description, name or category">
                <fieldset>
                ...
                <div class="site-header__branding__input__searchControls">
                    <input 
                    ...
                    name="search">
                    <button id="start" class="is-visible" value="Start" onclick="startButton()"  aria-label="Search with Voice">
                        <i class="fa fa-microphone" aria-hidden="true"></i>
                    </button>
                    <button id="stop" class="is-hidden" value="Stop" onclick="stopButton()"  aria-label="Stop recording with Voice">
        ...
        <!-- SCRIPT -->
        <script>
            /*FROM https://zafarsaleem.medium.com/adding-the-voice-search-feature-to-your-web-apps-3a9e4fcabb17 */
        ...
        event.preventDefault();
            if (startButton.classList.contains("is-visible")) {
        ...
        document.getElementById("stop").addEventListener("click", function(event){
            ...
            if (stopButton.classList.contains("is-visible")) {
        ...
        document.getElementById("searchProductsInput").value = saidText;
